...
function dl_enqueue_style() {
	...
	wp_enqueue_style( 'bootstrap', get_stylesheet_directory_uri() . '/css/bootstrap.css', null, 20180820, 'screen' );
	wp_register_style( 'main_style', get_theme_file_uri( '/assets/css/style.css'), array('reset'), $theme_data->get( 'Version' ), 'screen' );
	wp_enqueue_style( 'theme-style', get_stylesheet_directory_uri() . '/css/style.css', array('main_style'), 20180820, 'screen' );
